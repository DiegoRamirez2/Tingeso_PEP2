...
import LaboratorioUploadService from '../services/LaboratorioUploadService';
...
class LaboratorioUploadComponent extends Component{
  constructor(props) {
    super(props);
    this.state = {
      file: null
  ...
  onFileUpload = () => {
    ...
    if(respuesta){
      ...
      LaboratorioUploadService.CargarArchivo(formData).then((res) => {
      });
    }
    else{
    ...
    return (
      <div className='home'>
        ...
        <Styles>
          <div class="f">
            <div class="container">
              <h1><b>Cargar el archivo de Laboratorio</b></h1>
              <Row className="mt-4">
                <Col col="12">
                  ...
                  <Button varian="primary" onClick={this.onFileUpload}>
                    Cargar el archivo de Laboratorio a la base de datos.
                  </Button>
                </Col>
              </Row>
            </div>
...
export default LaboratorioUploadComponent;
